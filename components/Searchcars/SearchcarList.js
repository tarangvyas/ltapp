            ...
            if(numPages > 1) {
              ...
              for (let i = currentPage; i <= numPages; i++) {
                    ...
                    if (i != currentPage)
                        ...
                        pagesArray.push(<li className="active" key={i}><a href="javascript:void(0);">{i}</a></li>);
               j++;         
              }
              ...
              pagesArray.push(<style jsx>{`.pagination {border-radius: 0;}
                ...
                .pagination li.Previous a, .pagination li.next a {background: #38954f url("../images/pagesnation-ico.png") no-repeat; font-size: 0; height: 35px; margin: 0 4px; width: 50px;}
                .pagination li.Previous a{background-position: 14px 11px;}
                .pagination li.next a{background-position: -92px 11px;}`}</style>);
